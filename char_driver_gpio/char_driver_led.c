...
static ssize_t chardevnode_read(struct file *file , char __user *buf, size_t cnt,loff_t *f_ops)
{
  printk(KERN_EMERG "chardevnode_read is success!\n");
  return 0;
}

static ssize_t chardevnode_write(struct file *file , char __user *buf, size_t cnt,loff_t *f_ops)
{
  printk(KERN_EMERG "chardevnode_write is success!\n");
  return 0;
}

static loff_t chardevnode_llseek(struct file *file,loff_t *f_ops,int i)
{
  printk(KERN_EMERG "chardevnode_llseek is success!\n");
  return 0;
}
